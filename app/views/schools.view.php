...
<table class="table table-primary table-hover">
  <thead style="text-align:center;">
    <tr>
      ...
      <th scope="col"></th>
      <th scope="col" class="fa fa-plus"><a  class="btn btn-primary"href="<?php echo url('schools/form')?>">add New</a ></th>
  ...
  <tbody style="text-align: center;background-color:#eee;color: black;">
    <tr>
      ...
      <th scope="row"> <?php echo $key['school'];?></th>
      ...
      <td>
        <form method="POST" action="schools/Delete">
             <a class="btn btn-primary" href="<?php echo url('Schools/view/'.$key['id'])?>">Edit</a>
